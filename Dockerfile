...
RUN apt-get clean \
    ...
    && wget -P /tmp https://s3-eu-west-1.amazonaws.com/centreon-download/public/centreon-clib/centreon-clib-1.4.2.tar.gz \
    && wget -P /tmp https://s3-eu-west-1.amazonaws.com/centreon-download/public/centreon-connectors/centreon-connector-1.1.2.tar.gz \
    && wget -P /tmp https://s3-eu-west-1.amazonaws.com/centreon-download/public/centreon-engine/centreon-engine-1.4.15.tar.gz \
    && wget -P /tmp https://s3-eu-west-1.amazonaws.com/centreon-download/public/centreon-broker/centreon-broker-2.10.1.tar.gz \
    && wget -P /tmp http://archive.ubuntu.com/ubuntu/pool/multiverse/s/snmp-mibs-downloader/snmp-mibs-downloader_1.1.tar.gz \
    && wget -P /tmp https://s3-eu-west-1.amazonaws.com/centreon-download/public/centreon/centreon-2.6.6.tar.gz \
    && tar xvzf centreon-clib-1.4.2.tar.gz \
    && tar xvzf centreon-connector-1.1.2.tar.gz \
    && tar xvzf centreon-engine-1.4.15.tar.gz \
    && tar xvzf centreon-broker-2.10.1.tar.gz \
    && tar xvzf snmp-mibs-downloader_1.1.tar.gz \
    && tar xvzf centreon-2.6.6.tar.gz \
